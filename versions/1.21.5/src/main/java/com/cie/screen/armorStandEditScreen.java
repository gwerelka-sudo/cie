...
public class armorStandEditScreen extends Screen {
     ...
     */
    /**
     * [1.21.5] В этой версии нет EntityRenderState.light/.shadowPieces/.outlineColor
     ...
     * сущность (bodyYaw/setYaw/setPitch/headYaw/lastHeadYaw), без ограничения
    ...
    /**
     * [1.21.5] Общая логика драга панели/превью, вызывается КАЖДЫЙ КАДР
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        // [1.21.5] mouseDragged/mouseReleased НЕ вызываются движком для
    ...
    private class AxisSlider extends SliderWidget {
        ...
        public boolean mouseReleased(double mouseX, double mouseY, int button) {
            ...
            // [1.21.5] Старая система ввода: mouseReleased(double, double, int).
            rebuild();
            return result;
        }
