...
public final class LivePreviewRenderer {
    ...
    private static void onHudRender(DrawContext drawContext, RenderTickCounter tickCounter) {
        ...
        drawContext.drawItemInSlot(textRenderer, stack, itemX, itemY);
    ...
    private static void drawTooltip(DrawContext drawContext, TextRenderer textRenderer, ItemStack stack,
        ...
        TooltipType tooltipType = client.options.advancedItemTooltips
                ...
                : TooltipType.BASIC;
        Item.TooltipContext tooltipContext = client.world != null
                ? Item.TooltipContext.create(client.world)
                : Item.TooltipContext.create(client.getNetworkHandler() != null ? client.getNetworkHandler().getRegistryManager() : null);
        List<Text> lines = stack.getTooltip(tooltipContext, client.player, tooltipType);
        if (lines.isEmpty()) {
            LivePreviewUtil.clearTooltipBounds();
            return;
        }
