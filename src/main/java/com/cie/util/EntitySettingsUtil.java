...
public final class EntitySettingsUtil {
    ...
    private static TypedEntityData<EntityType<?>> getData(ItemStack stack) {
    ...
    public static NbtCompound getRoot(ItemStack stack) {
        TypedEntityData<EntityType<?>> data = getData(stack);
        return data != null ? data.copyNbtWithoutId() : new NbtCompound();
    }
    ...
    public static EntityType<?> getCurrentType(ItemStack stack) {
        TypedEntityData<EntityType<?>> data = getData(stack);
        return data != null ? data.getType() : getDefaultTypeForEgg(stack);
    }
    ...
    public static void saveRoot(ItemStack stack, EntityType<?> type, NbtCompound root) {
        stack.set(DataComponentTypes.ENTITY_DATA, TypedEntityData.create(type, root));
    }
    ...
    public static String getCustomName(ItemStack stack, RegistryWrapper.WrapperLookup registries) {
        ...
        try {
            var ops = registries.getOps(net.minecraft.nbt.NbtOps.INSTANCE);
